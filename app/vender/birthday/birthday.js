;(function($){
    ...
    $year.val(options.init.year);
    $month.val(options.init.month);
    $day.val(options.init.day);

	});
    };
    $.fn.birthday.change = function(obj){
	obj.find("select[name="+ $.fn.birthday.defaults.year +"],select[name="+ $.fn.birthday.defaults.month +"]").change(function(){
	    var $year = obj.find("select[name="+ $.fn.birthday.defaults.year +"]");
	    var $month = obj.find("select[name="+ $.fn.birthday.defaults.month +"]");
	    var $day = obj.find("select[name="+ $.fn.birthday.defaults.day +"]");
	    $day.empty();
